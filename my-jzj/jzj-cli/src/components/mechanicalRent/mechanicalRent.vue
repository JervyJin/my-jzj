  ...
  <section class="home">
    ...
    <div class="experience">
      <div class="jybox">
        <ul>
          ...
          <li class="leixing">机械类型：</li>
          <li class="infor">{{msg.brand}}</li>
        </ul>
        <ul>
          <li class="leixing">参考价格：</li>
          <li class="infor money">{{msg.money}}/月</li>
          <li class="leixing">出厂时间:</li>
          <li class="infor">{{msg.productionTime}}</li>
        </ul>
        <ul>
          <li class="leixing">机械名称：</li>
          <li class="infor">{{msg.machineName}}</li>
    ...
    <div class="about-list">
      ...
      <div class="box clearfix" >
        ...
        <div class="box-rg">
          <div class="type">【{{msg.tradeType}}】{{msg.machineName}}</div>
          <div class="rg-top">
            <span class="add">{{msg.address}}</span>
            <span class="price">{{msg.money}}</span>
          </div>
          <div class="mid">
            <img :src="msg.userPhoto" alt="">
            <span>{{msg.username}}</span>
          ...
          <div class="bot">
            <span>浏览：{{msg.clicks}}</span>
            <img src="../../assets/img/art.png" alt /> {{msg.commentNumber}}
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  created() {
    ...
    this.sub();
    this.http
      .post("http://192.168.0.162:8080/jzj-app/machine/selMachineById.do", {
        // carId: that.url.carId,
        // uuid: that.url.uuid
        machineId: "5555555555555555",
        uuid: "uuuuuuuu"
      })
      .then(res => {
        console.log(res);
        this.msg = res.result.machineMessage;
